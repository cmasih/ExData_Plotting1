...
png("plot2.png", width = 480, height = 480) #creating file to save plot to

plot(epcsubset$Time, epcsubset$Global_active_power, 
     type = "l",
...
dev.off() #closing connection with file created in order to create new plot 
